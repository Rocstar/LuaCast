Marjami_Ravine_Colonization_K08={
Name="Marjami Ravine Colonization K-8",
Author="Rockstar",
...
AshitaCore:GetDataModule():SendCommand( '/target ' .. 17867014, 0);
AshitaCore:GetDataModule():SendCommand( '/target ' .. 17867015, 0);
...
function Marjami_Ravine_Colonization_K08:OnLoad()
events.Add("onHandleNewChatLine","plugin_c_event",c);end

function Marjami_Ravine_Colonization_K08:OnUnload()
timer.RemoveTimer('s');events.Remove("onHandleNewChatLine","plugin_c_event");end 

return Marjami_Ravine_Colonization_K08;
