Marjami_Ravine_Colonization_L9={
...
function Marjami_Ravine_Colonization_L9:OnLoad()
timer.Create("s",3.1,0,s);events.Add("onHandleNewChatLine","plugin_c_event",c);end

function Marjami_Ravine_Colonization_L9:OnUnload()
timer.RemoveTimer('s');events.Remove("onHandleNewChatLine","plugin_c_event");end return Marjami_Ravine_Colonization_L9;
